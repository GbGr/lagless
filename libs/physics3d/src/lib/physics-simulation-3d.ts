...
const log = createLogger('PhysicsSimulation3d');

export class PhysicsSimulation3d extends ECSSimulation {
  ...
  constructor(
    ...
    private readonly _physicsWorldManager: PhysicsWorldManager3d,
  ) {
