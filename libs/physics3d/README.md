...
```bash
pnpm add @lagless/physics3d @lagless/rapier3d-deterministic-compat
```

Peer dependency: `@lagless/rapier3d-deterministic-compat >= 0.15.0`
...
@lagless/physics3d       (3D wrappers: PhysicsWorldManager3d, PhysicsStepSync3d, PhysicsRunner3d, ...)
        │
        └── peer: @lagless/rapier3d-deterministic-compat
```
