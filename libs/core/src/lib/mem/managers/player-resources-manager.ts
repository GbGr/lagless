...
export class PlayerResources {
  constructor(
    private readonly _playerResourcesManager: PlayerResourcesManager,
  ) {}

  public get<Ctor extends IPlayerResourceConstructor>(PlayerResourceConstructor: Ctor, playerSlot: number): InstanceType<Ctor> {
