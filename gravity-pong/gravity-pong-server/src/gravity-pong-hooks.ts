...
import { PlayerJoined, PlayerLeft } from '@lagless/gravity-pong-simulation';

const log = createLogger('GravityPongHooks');

export interface GravityPongResult {
  readonly winnerSlot: number;
  readonly scoreP0: number;
  readonly scoreP1: number;
}

export const gravityPongHooks: RoomHooks<GravityPongResult> = {
