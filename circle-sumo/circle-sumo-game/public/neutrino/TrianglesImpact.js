...
function NeutrinoEffect(ctx) {
	...
	this.textures = ['triangle_rotated_rect.png'];
	this.materials = [0];
	this.renderStyles = [{materialIndex:0,textureIndices:[0]}];
	this.Xe = 20;

	function Emitter_New_Emitter() {

		var _1 = [], _3 = [], _5, _6, _6i0, _6s0 = [], _8=[], _10=[], _10x=[], _10y=[], _10z=[], _9, _11, _12, _12i0, _12s0 = [];
		this.pe = [{xe:1,Rc:1,Sc:1,renderStyleIndex:0}];
		this.name = "New_Emitter";

		this.ud = function(Bd) {
			Bd.dd();
			Bd._6 = [
				[
					[20,20.0409,20.0864,20.1373,20.1949,20.2604,20.3362,20.4252,20.5325,20.6667,20.8447,21.1067,21.5449,22.0169,22.2901,22.463,22.463]
				]
			];
			Bd._12 = [
				[
		...
		this.fd = function(Bd, Xb) {
			...
			ctx.randv3gen(_3, 600, Bd.Ld.rand);
			Xb._4 = [];
			ctx.T(Xb._4, _3);
			_5 = 0 + Bd.Ld.rand() * (1 - 0);
		...
		this.qc = function(Qb, Bd, Xb) {
			...
			ctx.T(Xb.Ab, Xb._2);
			ctx.Q(_10z, [0,0,1]);
			ctx.I(_10y, _10z, Xb._4);
			ctx.Q(_10y, _10y);
			ctx.I(_10x, _10y, _10z);
			ctx.pb(_10, _10x, _10y, _10z);
			_9 = 0.25;
			_11 = (Xb._ / _9);
			_12i0=(_11<0?0:(_11>1?1:_11));
			_12i0<0.8?ctx.V(_12s0,0,(_12i0-0)*1.25):ctx.V(_12s0,1,(_12i0-0.8)*5);
			_12 = Db.nb(Bd._12[0][_12s0[0]],_12s0[1]);
			ctx.S(Xb.Pd,[0.5,0.5]);
			ctx.U(Xb.Mc, _10);
			ctx.V(Xb.Nd,Xb._7,Xb._7);
			ctx.T(Xb.gf,[1,1,1]);
			Xb.Od = _12;
			Xb.Qc = 0;
		}
