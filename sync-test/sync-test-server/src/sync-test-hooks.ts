...
import { PlayerJoined, PlayerLeft } from '@lagless/sync-test-simulation';

const log = createLogger('SyncTestHooks');

export interface SyncTestResult {
  readonly score: number;
}

export const syncTestHooks: RoomHooks<SyncTestResult> = {
