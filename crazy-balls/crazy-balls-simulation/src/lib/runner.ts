...
import { CrazyBallsSimulationCore, CrazyBallsSimulationInputRegistry } from './code-gen/index.js';
...
export class CrazyBallsRunner extends Physics2dRunner {
  constructor(Config: Physics2dConfig) {
    ...
    super(Config, localInputProvider, CRAZY_BALLS_SYSTEMS_REGISTRY, CrazyBallsSimulationCore);
  }
}
